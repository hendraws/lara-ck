...
<a class="btn btn-sm btn-primary ml-2 float-right" href="{{ action('UjianController@create') }}"    data-toggle="tooltip" data-placement="top" title="Tambah" >Buat Ujian Baru</a>
