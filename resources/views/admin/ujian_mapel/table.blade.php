		...
		<tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn btn-xs btn-primary" href="{{ action('UjianMataPelajaranController@index') }}?ujian={{ $item->id }}"  data-target="ModalForm" data-url="{{ action('MataPelajaranController@edit', $item) }}"  data-toggle="tooltip" data-placement="top" title="Pengaturan" data-id="{{ $item->id }}" >Tambah Soal</a>
